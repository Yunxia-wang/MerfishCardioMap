...
# Define the base path for all data.
# This single variable should point to the root directory
# containing all your data folders.
...
plot_result_dir = base_data_dir / '05_combined_cells_cluster_plot_iter1_umap2'

# %%
# Get the cell meta with cluster using the relative path
annotated_cell = pd.read_csv(cluster_datapath / 'cell_metadata_combine_with_cluster_iter1.csv')
